...
The default command is `-i` (stateless interactive mode). Override it to change
the mode or add flags, e.g. advanced stateful mode:

    podman run ... ghcr.io/<owner>/trex:latest -i --astf
